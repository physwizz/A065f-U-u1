...
struct LCM_DRIVER *o8_lcm_driver_list[] = {
        ...
        &lcd_ft8057p_xx_ctc_mipi_hd_video_lcm_drv,
#endif
#if defined(LCD_HX83108B_LS_HKC_MIPI_HD_VIDEO)
        &lcd_hx83108b_ls_hkc_mipi_hd_video_lcm_drv,
#endif
#if defined(LCD_GC7272_XX_HSD_MIPI_HD_VIDEO)
        &lcd_gc7272_xx_hsd_mipi_hd_video_lcm_drv,
#endif
#if defined(LCD_FT8057P_TXD_BOE_MIPI_HD_VIDEO)
        &lcd_ft8057p_txd_boe_mipi_hd_video_lcm_drv,
#endif
#if defined(LCD_HX83108B_LS_INX_MIPI_HD_VIDEO)
        &lcd_hx83108b_ls_inx_mipi_hd_video_lcm_drv,
#endif
